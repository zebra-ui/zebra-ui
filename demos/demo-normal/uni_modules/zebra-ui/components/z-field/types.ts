...
export type FieldFormatTrigger = 'onBlur' | 'onInput'

export type FieldValidateTrigger = 'onBlur' | 'onInput' | 'onSubmit'
...
export type FieldInstance = ComponentPublicInstance<any, FieldExpose>
