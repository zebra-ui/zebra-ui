  ...
  if (params.loop) {
    if (activeSlide.hasClass(params.slideDuplicateClass)) {
      ...
      let index = slides.findIndex((item) => {
        return (
          !item.hasClass(params.slideDuplicateClass) &&
          item.dataSwiperSlideIndex == realIndex
        )
      })
  ...
  if (params.loop) {
    ...
    if (nextSlide.hasClass(params.slideDuplicateClass)) {
      ...
      let index = slides.findIndex((item) => {
        return (
          !item.hasClass(params.slideDuplicateClass) &&
          item.dataSwiperSlideIndex == nextSlide.dataSwiperSlideIndex
        )
      })
    ...
    if (prevSlide.hasClass(params.slideDuplicateClass)) {
      ...
      let index = slides.findIndex((item) => {
        return (
          !item.hasClass(params.slideDuplicateClass) &&
          item.dataSwiperSlideIndex == prevSlide.dataSwiperSlideIndex
        )
      })
